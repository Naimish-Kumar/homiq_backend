...
<head>
    ...
    <title>HomiQ - Password Reset OTP</title>
    <style>
        /* Email client resets */
        ...
        /* Note Box */
        .info-box { background-color: #FEF2F2; border-radius: 8px; padding: 16px; margin-bottom: 24px; text-align: left; }
        .info-text { font-size: 13px; line-height: 1.5; color: #991B1B; margin: 0; }
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="text">We received a request to reset your HomiQ account password. Please use the 6-digit verification code below to complete the reset process.</p>
